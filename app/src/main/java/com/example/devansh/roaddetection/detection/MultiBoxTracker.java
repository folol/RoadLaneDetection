    ...
    public synchronized void draw(final Canvas canvas) {
        ...
        for (final TrackedRecognition recognition : trackedObjects) {
           ...
           // canvas.drawRect(trackedPos,boxPaint);
            float offset = trackedPos.width()/2;
            canvas.drawLine(
                    trackedPos.left, // startX
                    trackedPos.bottom, // startY
                    trackedPos.left+offset-100, // stopX
                    trackedPos.top, // stopY
                    boxPaint // Paint
            );
            canvas.drawLine(
                    trackedPos.right, // startX
                    trackedPos.bottom, // startY
                    trackedPos.right-offset+100, // stopX
                    trackedPos.top, // stopY
                    boxPaint // Paint
            );
